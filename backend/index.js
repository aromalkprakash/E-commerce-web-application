...
mongoose
  .connect(
    "mongodb+srv://aromalkprakashofficial:elliotalderson1324@cluster0.y0ldf6x.mongodb.net/e-commerce"
  )
...
app.post("/signup", async (req, res) => {
  const checkExistingEmail = await Users.findOne({ email: req.body.email });
  ...
  if (password.length < 6) {
    return res
      .status(400)
      .json({ error: "password should be at-least 6 character long" });
  }
